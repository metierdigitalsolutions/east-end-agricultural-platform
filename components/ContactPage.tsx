            ...
            <Card>
              ...
              <CardContent className="space-y-4">
                {contactMethods.map((method, index) => (
                  ...
                  >
                    <method.icon
                      className={`h-6 w-6 ${method.color} mt-1 mr-4 flex-shrink-0`}
                    />
                ...
                <div className="space-y-2">
                  ...
                  <div className="mt-4 p-3 bg-green-50 rounded-lg">
                    <p className="text-sm text-green-800">
                      <strong>24/7 WhatsApp Support:</strong> For urgent
                      matters, our WhatsApp support is available around the
                      clock.
                    </p>
                  </div>
                </div>
